...
export function TableSkeleton() {
  return (
    <table className="w-full border border-gray-300 border-separate border-spacing-0 shadow-lg rounded-lg overflow-hidden text-[0.6rem]/[1rem] sm:text-sm md:text-base">
